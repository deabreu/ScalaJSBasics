...
$c_Ltutorial_webapp_TutorialApp$.prototype.getChildCount__Lorg_scalajs_dom_raw_Node__I = (function(targetNode) {
  return $uI(targetNode.childNodes.length)
});
...
$c_Ltutorial_webapp_TutorialApp$.prototype.appendPar__Lorg_scalajs_dom_raw_Node__T__V = (function(targetNode, text) {
  ...
  var parameterCount = this.getChildCount__Lorg_scalajs_dom_raw_Node__I(targetNode);
  var textNode = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createTextNode(((text + " - contagem ") + parameterCount));
  parNode.appendChild(textNode);
  if ((((parameterCount % 4) | 0) === 0)) {
...
//# sourceMappingURL=scalajsbasictutorial-fastopt.js.map
